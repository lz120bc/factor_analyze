...
inc['ebi_mean'] = inc.groupby('id')['ebi'].rolling(window=12).mean().values
...
# fill gaps
inc['ebi_mean'] = inc.groupby('id')['ebi'].rolling(window=3, min_periods=1).mean().values
inc['inc_mean'] = inc.groupby('id')['inc'].rolling(window=3, min_periods=1).mean().values
